...
class RegistrationController extends Controller
{
    public function registerAction(Request $request)
    {
      ...
      $url = $this->generateUrl('ubv_autenticacion_usuarios', array('pagination' => $pagination));
      
      return new RedirectResponse($url);
            }
            
            // Comentar siguiente linea sino se desea que el usuario que se registre se loguee automaticamente.
